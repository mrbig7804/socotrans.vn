...
namespace Zensoft.Website.Utilities.HTML
{
    public class ParseHTML : Parse {
        ...
        public string EmbedVideoYoutube(int with, int height, string videoId, bool autoplay)
        {
            string strHTML = "";
            strHTML += "<iframe width='" + with.ToString() + "' height='" + height.ToString() + "'";
            strHTML += " src='http://www.youtube.com/embed/" + videoId;
