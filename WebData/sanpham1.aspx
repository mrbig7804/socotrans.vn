<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateHome.master" AutoEventWireup="true" CodeFile="sanpham1.aspx.cs" Inherits="sanpham1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHomePage" Runat="Server">
    ...
    <asp:Literal runat="server" ID="ltrDescription" Visible="false" />
