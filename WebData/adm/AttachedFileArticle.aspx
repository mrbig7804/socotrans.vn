<%@ page language="C#" autoeventwireup="true" codefile="AttachedFileArticle.aspx.cs" inherits="adm_AttachedFileArticle" %>
...
<body>
    ...
    <form runat="server">
        ...
        <%--<asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Làm mới dữ liệu</asp:LinkButton>--%>
            ...
            <itemtemplate>
                <li>
                    ...
                    <div class="info">
                        ...
                        <span>
                            <b>Dung lượng: </b><%# string.Format("{0:###,###}", long.Parse(((DictionaryEntry)Container.DataItem).Value.ToString()))%> byte
                        </span>
                        <span>
