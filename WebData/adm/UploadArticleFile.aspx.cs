...
public partial class adm_UploadArticleFile : Zensoft.Website.UI.BasePage
{
    ...
    string UploadForArticle(WebControls.UploadButtonEventArgs e)
    {
            ...
            e.FileUploadControl.PostedFile.ContentLength <= AppConfiguration.MaxSizeUploadFile)
        {
            ...
            myUploadHandler.VirtualSavePath = "~/Attachs/Articles/" + this.Request["ArticleID"].ToString() + "/"; // ApplicationSettingsGroup Configuration.TempImagesFolder;
