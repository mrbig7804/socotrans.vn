<%@ page language="C#" title=": : Zensoft Admin - Bài viết - Các bài viết không được hiển thị : :"
    masterpagefile="~/adm/AdminTemplate.master" autoeventwireup="true" codefile="ManageArtilceUnlisted.aspx.cs"
...
<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="Server">
    ...
    <p class="sectionTitle">
        Danh sách các bài viết không được hiển thị</p>
    <asp:gridview id="GridView1" runat="server" allowpaging="True" autogeneratecolumns="False"
        datakeynames="ArticleID" datasourceid="ObjectDataSource1" width="100%" onrowcommand="GridView1_RowCommand"
        onrowcreated="GridView1_RowCreated" bordercolor="#999999" borderstyle="Solid"
    ...
    <asp:objectdatasource id="ObjectDataSource1" runat="server" deletemethod="Delete"
        selectmethod="GetArticlesUnListed" typename="Zensoft.Website.BusinessLayer.BusinessFacade.ArticlesBF">
        <deleteparameters>
