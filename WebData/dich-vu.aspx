<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateHome.master" AutoEventWireup="true" CodeFile="dich-vu.aspx.cs" Inherits="dich_vu" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphHomePage">
    ...
    <div class="main-cc pageArticles">
        <asp:HiddenField ID="hdfCatID" runat="server" Value="106" />
