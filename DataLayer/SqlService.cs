...
namespace Zensoft.Website.DataLayer
{
    public class SqlService
    {
        ...
        public SqlService()
        {
           _connectionString = "Data Source=SERVER;Initial Catalog=Zensoft_DB;User ID=sa;Password=123456";//WebConfigurationManager.ConnectionStrings["ZensoftSqlServer"].ConnectionString;
        }
        ...
        public SqlService(string configKey)
        {
            ...
            //{
            //    _connectionString = System.Configuration.co["System.Configuration"];
            //}
            //else
            //{
